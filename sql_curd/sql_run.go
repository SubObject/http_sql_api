...
//shiyan
func (m *Models) Selecting(receiveModels ...interface{}) (resultSlice string, err error){
	defer m.InitModel()
...
//分页查询
func (m *Models) Paginate(page int,pagesize int,receiveModels ...interface{}) (resultSlice []map[string]string, err error){
	if page < 1 {
		page = 1
	}
	if pagesize < 0 {
